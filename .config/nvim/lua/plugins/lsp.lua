...
local function set_keymap(client, buf)
  ...
  map("n", "[d", Util.diagnostic_goto(false), "Previous Diagnostic")
  map("n", "]e", Util.diagnostic_goto(true, "ERROR"), "Next Error")
  map("n", "[e", Util.diagnostic_goto(false, "ERROR"), "Previous Error")
  map("n", "]w", Util.diagnostic_goto(true, "WARN"), "Next Warning")
  map("n", "[w", Util.diagnostic_goto(false, "WARN"), "Previous Warning")
