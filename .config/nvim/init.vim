...
nmap <silent><nowait> <leader>lS :<C-u>CocFzfList -I symbols<cr>
...
" plugin: wiki {{{
let g:wiki_root = '~/Sync/Notes2/notes'
...
let g:wiki_export = {
  ...
  \ 'view' : v:true,
  \ 'output': fnamemodify(resolve(expand('%')), ':p:h') . '/exported',
  \}
...
nmap <silent> <localleader>d <plug>(wiki-page-delete)
nmap <silent> <localleader>r <plug>(wiki-page-rename)
